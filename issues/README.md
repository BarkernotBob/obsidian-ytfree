...
| [046](046-in-progress-chip.md) | An "In progress" list: what you started and did not finish | **Built 2026-09-02** — a fifth chip, second in the row. Floor is `min(0.1 × duration, 120s)`; backed by `progress.json`, never frontmatter. Manual test in the issue |
