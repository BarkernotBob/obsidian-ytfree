...
| 003 | Subscriptions hub: poll subscribed channels, click a video into a note | Scoped ([docs/V1-SCOPE-SUBSCRIPTIONS.md](../docs/V1-SCOPE-SUBSCRIPTIONS.md)) — not built |
